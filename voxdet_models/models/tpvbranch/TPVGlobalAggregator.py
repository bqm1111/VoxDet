from voxdet_core import BACKBONES, BaseModule, build_backbone, build_neck
import torch
...
class TPVGlobalAggregator(BaseModule):
    def __init__(
        ...
        self.global_encoder_backbone = build_backbone(global_encoder_backbone)
        self.global_encoder_neck = build_neck(global_encoder_neck)
