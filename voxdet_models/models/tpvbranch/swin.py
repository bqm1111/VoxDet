...
from voxdet_core import build_norm_layer
from voxdet_core import FFN, build_dropout
from voxdet_core import BaseModule, ModuleList
from voxdet_core import constant_init, trunc_normal_, trunc_normal_init
from voxdet_core.checkpoint import CheckpointLoader
from voxdet_core import to_2tuple
from voxdet_core import BACKBONES
...
class Swin(BaseModule):
    ...
    def init_weights(self):
        logger = logging.getLogger('voxdet')
