...
from voxdet_core import build_backbone, build_neck
...
class LocalAggregator(BaseModule):
    def __init__(
        ...
        super().__init__()
        self.local_encoder_backbone = build_backbone(local_encoder_backbone)
        self.local_encoder_neck = build_neck(local_encoder_neck)
