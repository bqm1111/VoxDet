...
import glob
import numpy as np
from voxdet_core import DATASETS
from torch.utils.data import Dataset
from voxdet_core.data import Compose
from voxdet_models.datasets.pipelines import LoadMultiViewImageFromFiles
        ...
        for sequence in self.sequences:
            ...
            for id_path in glob.glob(id_base_path):
                ...
                stereo_depth_path = os.path.join(
                    self.stereo_depth_root, "sequences", sequence, img_id + ".npy"
                )
...
if __name__ == "__main__":
    ...
    dataset = SemanticKITTIDataset(
        ...
        stereo_depth_root="data/dataset/kitti/dataset/depth/",
        camera_used=["left"],
        occ_size=[256, 256, 32],
